...
/*
Função para gravar no csv o resumo final do benchmark
 */
...
/*
Função para gravar no csv informações sobre cada imagem inferida no benchmark
 */
...
O titulo sempre será com base na data e horário de criação
 */
FILE *create_csv(){
