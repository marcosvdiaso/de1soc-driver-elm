...
/*
Função para montar binário do pixel
Handshake de enable_write/disable
*/
...
/*
Função para pintar a tela toda de preta (Reset)
*/
void vga_reset()
{
  for (int x = 0;x<320;x++){
...
Cada pixel 1x1 é ampliada para uma versão de si mesmo em 7x7
*/
...
/*
Função para desenhar char com base na biblioteca font8x8 
*/
...
/*
Função para desenhar uma string completa
*/
...
/*
Função para desenhar uma célula da grade com a cor do pixel correspondente
*/
...
/*
Função para restaurar o desenho na posição anterior do cursor, apagando o rastro
*/
