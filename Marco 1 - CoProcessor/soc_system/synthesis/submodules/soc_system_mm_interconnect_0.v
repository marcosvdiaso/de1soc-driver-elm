...
module soc_system_mm_interconnect_0 (
	...
	wire  [129:0] signals_s1_agent_rf_source_data;                                                    // signals_s1_agent:rf_source_data -> signals_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] signals_s1_agent_rsp_fifo_out_data;                                                 // signals_s1_agent_rsp_fifo:out_data -> signals_s1_agent:rf_sink_data
	...
	wire  [128:0] data_out_s1_agent_rp_data;                                                          // data_out_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [128:0] signals_s1_agent_rp_data;                                                           // signals_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [128:0] data_in_s1_agent_rp_data;                                                           // data_in_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> data_out_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // data_out_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> data_out_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> signals_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // signals_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> signals_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] signals_s1_burst_adapter_source0_data;                                              // signals_s1_burst_adapter:source0_data -> signals_s1_agent:cp_data
	wire          signals_s1_burst_adapter_source0_ready;                                             // signals_s1_agent:cp_ready -> signals_s1_burst_adapter:source0_ready
	wire    [6:0] signals_s1_burst_adapter_source0_channel;                                           // signals_s1_burst_adapter:source0_channel -> signals_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> data_in_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // data_in_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> data_in_s1_burst_adapter:sink0_channel
